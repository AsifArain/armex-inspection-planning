...
%--- parameters
%==============================================================
map_filename  = 'prismaforum5.pgm';
yaml_filename = 'prismaforum5.yaml';
%==============================================================
...
mapCut = [128.5100  150.5100  226.9800   58.9800];
...
%-- save
filename = 'prismaforum5_mapcut_original.dat';
...
%-- save
filename = 'prismaforum5_map_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_original,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);


filename = 'prismaforum5_origin_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_original,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_mapsize_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_original),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_cellsize_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
...
%-- save
filename = 'prismaforum5_map_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_raycast,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_origin_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_raycast,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_mapsize_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_raycast),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_cellsize_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
...
%-- grow obstacles
r_cov  = 0.00/dataYAML.resolution;
...
filename = 'prismaforum5_map_coverageL.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_coverage,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_origin_coverageL.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_original,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_mapsize_coverageL.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_coverage),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_cellsize_coverageL.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,dataYAML.resolution,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);
...
filename = 'prismaforum5_map_coverage.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_coverage,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_origin_coverage.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_coverage,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_mapsize_coverage.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_coverage),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_cellsize_coverage.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
...
filename = 'prismaforum5_map_navigation.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_navigation,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_origin_navigation.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_navigation,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_mapsize_navigation.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_navigation),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_cellsize_navigation.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
...
filename = 'prismaforum5_map_conf.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_conf,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_origin_conf.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_conf,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_mapsize_conf.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_conf),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum5_cellsize_conf.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
