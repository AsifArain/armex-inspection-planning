...
%-- save
filename = 'prismaforum2_map_original.dat';
...
filename = 'prismaforum2_origin_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_original,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum2_mapsize_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_original),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum2_cellsize_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
...
%-- save
filename = 'prismaforum2_map_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_raycast,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum2_origin_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_raycast,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum2_mapsize_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_raycast),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum2_cellsize_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
