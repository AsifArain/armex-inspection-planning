...
%--- parameters
%==============================================================
map_filename  = 'prismaforum4.pgm';
yaml_filename = 'prismaforum4.yaml';
%==============================================================
...
mapCut = [64.5100  150.5100  292.9800   64.9800];
% mapCut = [67.5100  155.5100  292.9800   59.9800];
...
%-- save
filename = 'prismaforum4_map_original.dat';
...
filename = 'prismaforum4_origin_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_original,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_mapsize_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_original),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_cellsize_original.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
...
%-- save
filename = 'prismaforum4_map_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_raycast,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_origin_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_raycast,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_mapsize_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_raycast),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_cellsize_raycast.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
...
filename = 'prismaforum4_map_coverageL.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_coverage,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_origin_coverageL.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_original,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_mapsize_coverageL.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_coverage),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_cellsize_coverageL.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,dataYAML.resolution,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);
...
filename = 'prismaforum4_map_coverage.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_coverage,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_origin_coverage.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_coverage,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_mapsize_coverage.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_coverage),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_cellsize_coverage.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
...
filename = 'prismaforum4_map_navigation.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_navigation,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_origin_navigation.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_navigation,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_mapsize_navigation.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_navigation),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_cellsize_navigation.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
...
filename = 'prismaforum4_map_conf.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,map_conf,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_origin_conf.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,origin_conf,'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_mapsize_conf.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
dlmwrite(filename,size(map_conf),'-append','delimiter',' ');
fileID = fopen(filename,'a'); fclose(fileID);

filename = 'prismaforum4_cellsize_conf.dat';
fileID = fopen(filename,'wt'); fclose(fileID);
