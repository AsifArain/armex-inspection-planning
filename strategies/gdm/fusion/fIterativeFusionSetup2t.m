function [ ConfPair_ioh ] = fIterativeFusionSetup2t( map_env,...
                                                     PairNumberToSelect,...
                                                     currentFusedConfs,...
                                                     cellsize_env,...
                                                     para_ )
...
%**********************************************************************
[conf_r,conf_c] = ind2sub(size(map_env),conf_io(:,1));
dist = zeros(size(conf_io,1));
for i = 1:size(dist,1)
...
%{
% - initialize the pair
ConfPair_ioh = zeros(2,2+size(selectedFusedConf_ind,1));

% - index and orinetations
ConfPair_ioh(:,1:2) = conf_io(conf_num_ab,:);
