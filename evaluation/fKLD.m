...
% ASIF
P_vec = GT(:);  % single vector P
Q_vec = GDM(:); % signle vector Q
KLDiv = P_vec.*(log2(P_vec+eps)-log2(Q_vec+eps)); % divergence vector
meanDiv = mean(KLDiv); % mean divergence
